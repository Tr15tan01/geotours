        ...
        <Container>
            <div className="row featurette">
                ...
                <div className="col-md-5 order-md-1">
                    ...
                    <div className="features-image" style={{ backgroundImage: `url(${img1})` }}></div>
                </div>
            </div>
            ...
            <div className="row featurette">
                <div className="col-md-7 order-md-2">
                    ...
                    <Link className="btn btn-info shadow text-white" to="detailed">View details &raquo;</Link>
                </div>
                <div className="col-md-5 order-md-1">
                    <div className="features-image" style={{ backgroundImage: `url(${img2})`, backgroundSize: 'cover' }}></div>
                </div>
            </div>
            ...
            <div className="row featurette">
                ...
                <div className="col-md-5">
                    <div className="features-image" style={{ backgroundImage: `url(${img3})` }}></div>
                </div>
            </div>
            <hr className="featurette-divider" />
        </Container>
